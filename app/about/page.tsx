...
export default function AboutPage() {
  return (
    <main>
      <HabbaHeader />
      <section className="mx-auto w-[92%] max-w-4xl space-y-5 py-8 md:py-10">
        <article className="rounded-3xl border border-[#F0DED0] bg-[#fff7ee] p-5 md:p-7">
          ...
          <p className="mt-3 text-right leading-relaxed text-[#615651]">
            حبّة مش براند فخامة. حبّة تفاصيل صغيرة، ألوان خفيفة، وقطع خرز handmade تتلبس بسهولة وتتنفع كهدية بسيطة.
          </p>
          <p className="mt-2 text-right text-sm text-[#7B6F68]">
        ...
        <article className="rounded-3xl border border-[#F0DED0] bg-[#fff7ee] p-5 md:p-6">
          <h2 className="text-right text-xl font-bold">قبل ما تطلبي</h2>
        ...
        <article className="rounded-3xl border border-[#F0DED0] bg-[#FFFCF7] p-5 text-right md:p-7">
          <h2 className="text-2xl font-bold">تواصلي معنا</h2>
          <p className="mt-2 text-sm text-[#615651] sm:text-base">اطلبي أو اسألي عن أي قطعة عبر واتساب.</p>
          <a
